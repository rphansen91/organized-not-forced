...
```mermaid
flowchart LR
    A["⚡ BREAKTHROUGH<br/>The moment it clicked"] 
    B["⏪ FLASHBACK<br/>How I got here"]
    C["🔥 THE STRUGGLE<br/>What wasn't working"]
    D["💡 THE SHIFT<br/>What changed"]
    E["🌊 THE CARRYOVER<br/>Where else it showed up"]
...
```mermaid
flowchart TD
    subgraph OPEN["OPENING: THE BREAKTHROUGH"]
        O1["⚡ Pike position — gravity clicks"]
        O2["'Effortless but strong'"]
    end

    subgraph PART1["PART I: THE BEGINNING"]
        A1[🎯 The 5 Goals] --> A2[📊 Where I Started]
        A2 --> A3[❌ The Old Way: Try Harder]
    end

    subgraph PART2["PART II: THE SKILLS"]
        C1[🦵 Pistol Squat] --> C2[💪 Muscle-Up]
        C2 --> C3[🙃 Handstand Push-Up]
        C3 --> C4[📐 Front Lever]
        C4 --> C5[✈️ Full Planche]
    end

    subgraph PART3["PART III: THE PRINCIPLES"]
        B1[🦴 Skeleton Before Muscles]
        B2[🔗 Scapula as Transmission Hub]
        B3[🔓 Taking the Brakes Off: Joints]
        B4[⚡ Force Transfer]
    end

    subgraph PART4["PART IV: INTEGRATION"]
        D1[🏄 Surfing Carryover] --> D2[🧠 The Transformation]
    end
    ...
    style OPEN fill:#ce93d8
    style PART1 fill:#e8f4f8
...
```mermaid
gantt
    title Journey Timeline → Chapters
    dateFormat  YYYY-MM
    
    section Opening
    Prologue: Pike Breakthrough      :milestone, 2026-05, 0d
    
    section Part I: Beginning
    Ch 1: The 5 Goals                :done, 2025-11, 2025-12
    Ch 2: The Old Way                :done, 2025-11, 2026-01
    
    section Part II: Skills
    Ch 3: Pistol Squat               :done, 2026-01, 2026-05
    Ch 4: Muscle-Up                  :active, 2026-02, 2026-07
    Ch 5: Handstand Push-Up          :2026-06, 2026-09
    Ch 6: Front Lever                :2026-07, 2026-12
    Ch 7: Planche                    :crit, 2026-09, 2026-12
    
    section Part III: Principles
    Ch 8: Skeleton Before Muscles    :2026-10, 2026-12
    Ch 9: Scapula Discovery          :2026-10, 2026-12
    Ch 10: Joints as Entry Points    :2026-01, 2026-12
    
    section Part IV: Integration
    Ch 11: Carryover                 :2026-05, 2026-12
    Ch 12: Organized Not Forced      :crit, 2026-12, 2027-01
```
...
flowchart LR
    subgraph BEFORE["❌ BEFORE"]
        ...
        B1["Try harder"]
        B2["Squeeze more"]
        B3["Force the movement"]
        B4["Stretch, yoga, massage"]
        B5["Disconnected movements"]
    end

    subgraph SHIFT["⚡ THE SHIFT"]
        direction TB
        S1["Feel the sensation"]
        S2["Name the pattern"]
        S3["Let it organize"]
    end
    ...
    subgraph AFTER["✅ AFTER"]
        direction TB
        A1["Create conditions"]
        A2["Body organizes itself"]
        A3["Force transfers cleanly"]
        A4["Active mobility under load"]
        A5["Carryover to all movement"]
    end

    BEFORE --> SHIFT --> AFTER

    style BEFORE fill:#ffebee
    style SHIFT fill:#fff8e1
...
```mermaid
flowchart TB
    M26["Message 26: First sensation<br/>'feeling more lift with elbows forward'"]
    M30["Message 30: Hitting wall<br/>'shoulders give out at transition'"]
    M120["Message 120: First unassisted pistol! 🎉"]
    M142["Message 142: 'Hollow body coming online'"]
    M187["Message 187: Surfing proof<br/>'caught large waves after 3 weeks off'"]
    M189["Message 189: Ankle healing<br/>'taking the breaks off'"]
    M250["Message 250: Asymmetry awareness<br/>'left impingement vs right control'"]
    M294["Message 294: Depression reframe<br/>'torso organizing shoulder girdle'"]
    M302["Message 302: Pike breakthrough<br/>'gravity organizing scap onto ribcage'"]
    M303["Message 303: Force transfer mastery<br/>'effortless but strong'"]
    ...
    style M120 fill:#c8e6c9
    style M189 fill:#fff9c4
    style M294 fill:#ffcc80
    style M302 fill:#ef9a9a
    style M303 fill:#ce93d8
```
...
```mermaid
mindmap
  root((Organized<br/>Not Forced))
    Skeleton First
      Alignment before activation
      Structure enables strength
    Ribcage Organizes
      Depression = torso stacking
      Not "pull shoulders down"
    Gravity as Teacher
      Pike breakthrough
      Let it stack you
    Active Mobility
...
```mermaid
flowchart LR
    subgraph PHASE1["Phase 1: The Hook"]
        P["Prologue: Pike Breakthrough"]
    end
    
    subgraph PHASE2["Phase 2: Richest Material"]
        W3["Ch 3: Pistol Squat"]
        W7["Ch 7: Planche"]
    end
    
    subgraph PHASE3["Phase 3: The Struggle"]
        W4["Ch 4: Muscle-Up"]
        W2["Ch 2: The Old Way"]
    end
    ...
    subgraph PHASE4["Phase 4: Integration"]
        W10["Ch 10: Carryover"]
        W11["Ch 11: Transformation"]
    end
    
    subgraph PHASE5["Phase 5: Fill In"]
        W1["Ch 1: Goals"]
        W5["Ch 5: HSPU"]
        W6["Ch 6: Front Lever"]
        W8["Ch 8-9: Principles"]
    end

    PHASE1 --> PHASE2 --> PHASE3 --> PHASE4 --> PHASE5

    style PHASE1 fill:#ce93d8
    style PHASE2 fill:#c8e6c9
    style PHASE3 fill:#ffcdd2
    style PHASE4 fill:#fff9c4
    style PHASE5 fill:#e8f4f8
```
